...
/**
 * Api services for the `AnswerList` model.
 */
@Injectable()
export class AnswerListApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `AnswerList` object.)
   * </em>
   */
