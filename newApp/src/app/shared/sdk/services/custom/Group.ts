...
export class GroupApi extends BaseLoopBackApi {
  ...
  /**
   * Fetches hasOne relation runningGames.
   *
   * @param {any} id Group id
   *
   ...
   * </em>
   */
  public getRunningGames(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
  ...
  /**
   * Update runningGames of this model.
   *
   * @param {any} id Group id
   *
   * @param {object} data Request data.
   ...
   * </em>
   */
  public updateRunningGames(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Groups/:id/runningGames";
    let _routeParams: any = {
  ...
  /**
   * Deletes runningGames of this model.
   *
   * @param {any} id Group id
   *
   * @returns {object} An empty reference that will be
   ...
   * This method returns no data.
   */
  public destroyRunningGames(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Groups/:id/runningGames";
    let _routeParams: any = {
  ...
  public getCurrent(filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() + "/Groups" + "/:id";
   ...
   * call to {@link sdk.Group#login} or
   * {@link sdk.Group#getCurrent}. Return null when there
  ...
  /**
   * @name sdk.Group#isAuthenticated
   *
