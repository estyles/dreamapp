...
/**
 * Api services for the `GameGroup` model.
 */
@Injectable()
export class GameGroupApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `GameGroup` object.)
   * </em>
   */
