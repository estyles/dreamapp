...
/**
 * Api services for the `RunningGame` model.
 */
@Injectable()
export class RunningGameApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `RunningGame` object.)
   * </em>
   */
  public findByIdGameGroups(id: any, fk: any, customHeaders?: Function): Observable<any> {
   ...
   */
  public destroyByIdGameGroups(id: any, fk: any, customHeaders?: Function): Observable<any> {
   ...
   * </em>
   */
  public updateByIdGameGroups(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
   ...
   * </em>
   */
  public getGame(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
  ...
  /**
   * Creates a new instance in stage of this model.
   *
   * @param {any} id RunningGame id
   *
   * @param {object} data Request data.
   ...
   * </em>
   */
  public createStage(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
   ...
   * </em>
   */
  public updateStage(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RunningGames/:id/stage";
    let _routeParams: any = {
   ...
   * This method returns no data.
   */
  public destroyStage(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RunningGames/:id/stage";
    let _routeParams: any = {
   ...
   * </em>
   */
  public getGameGroups(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * </em>
   */
  public createGameGroups(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RunningGames/:id/gameGroups";
    let _routeParams: any = {
   ...
   * This method returns no data.
   */
  public deleteGameGroups(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RunningGames/:id/gameGroups";
    let _routeParams: any = {
   ...
   *  - `count` – `{number}` - 
   */
  public countGameGroups(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * </em>
   */
  public createManyStage(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RunningGames/:id/stage";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createManyGameGroups(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RunningGames/:id/gameGroups";
    let _routeParams: any = {
